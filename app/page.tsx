      ...
      <section className="h-full grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="flex items-center justify-center px-6 py-12 sm:px-10 md:px-16">
          <div className="w-full max-w-md">
            <div>
              <img src="/logo.webp" className="w-46" alt="" />
            </div>
            ...
            {step === "email" ? (
              <form className="mt-10 space-y-5" onSubmit={handleEmailSubmit}>
                ...
                <button
                  type="submit"
                  className="flex h-12 w-full cursor-pointer items-center justify-center rounded-2xl bg-[#01371B] text-base font-medium text-[#A3E42F] transition hover:bg-[#262626] focus:outline-none focus:ring-4 focus:ring-[#d9d9d9]"
                >
                  Get OTP
                </button>
              </form>
              ...
              <form className="mt-10 space-y-6" onSubmit={handleOtpSubmit}>
                ...
                <button
                  ...
                  className="text-sm font-medium text-[#7a7a7a] transition hover:text-[#171717] cursor-pointer"
                >
